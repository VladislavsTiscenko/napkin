\documentclass[11pt,a5paper,twoside=semi,openright,numbers=noenddot,titlepage=false]{scrbook}
\usepackage[a5paper, top=2cm, bottom=3.5cm, left=2cm, right=2cm]{geometry}
